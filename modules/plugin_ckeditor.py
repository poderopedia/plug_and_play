...
class CKEditor(object):
    ...
    def __init__(self, db):
        ...
        self.settings.table_draft = None
        self.settings.table_draft_name = 'drafts'
        ...
        self.settings.url_save_draft = URL('plugin_ckeditor', 'save_draft')
        self.settings.timeout_save_draft = 120      #segundos
    ...
    def define_tables(self, migrate=True, fake_migrate=False):
        ...
        draft_name = self.settings.table_draft_name
        ...
        self.settings.table_draft = self.db.define_table(draft_name,
            Field('reference_table', length=255),
            Field('reference_id', 'integer'),
            Field('table_field', length=255),
            Field('created_by', 'integer'),
            Field('modified_on', 'datetime'),
            migrate = migrate,
            fake_migrate = fake_migrate,
            format = '%(created_by)s %(modified_on)s'
        )
